...
- [ ] T012 [P] [US1] Security test for [security-sensitive feature] in tests/security/test_[name].py (if handling sensitive data)
...
- [ ] T021 [P] [US2] Security test for [security-sensitive feature] in tests/security/test_[name].py (if handling sensitive data)
...
- [ ] T028 [P] [US3] Security test for [security-sensitive feature] in tests/security/test_[name].py (if handling sensitive data)
